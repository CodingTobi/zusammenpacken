...
const Sidebar: React.FC = () => {
  return (
    <aside className="w-16 flex flex-col items-center bg-gray-800 text-white fixed h-full z-10">
      <div className="flex flex-col justify-between h-full w-full">
        <nav aria-label="Main">
          <div className='h-2'></div> {/*space before logo, improve?*/}
          <div className='flex m-auto mb-2 w-10 h-10 bg-slate-300 rounded-full'>
